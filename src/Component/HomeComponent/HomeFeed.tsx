...
const HomeFeed = ({ onNavigate }: HomeFeedProps) => {
        ...
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            <Avatar className="h-8 w-8">
              <AvatarImage src="https://images.unsplash.com/photo-1556157382-97eda2d62296?w=150&h=150&fit=crop&crop=face" />
              <AvatarFallback>YU</AvatarFallback>
            </Avatar>
            <h1 className="text-lg font-semibold"><span className="font-bold">nexus</span> Campus</h1>
          </div>
