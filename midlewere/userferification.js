...
const verifyUD = async (req) => {
  ...
  if (Userdata.UserType.Code !== EnumsCode.Useres.UD.toUpperCase()) {
...
const verifyEventMagAdmin = async (req) => {
  ...
  if (Userdata.UserType.Code !== EnumsCode.Useres.EventMagAdmin.toUpperCase()) {
...
const verifyEventMagStaff = async (req) => {
  ...
  if (Userdata.UserType.Code !== EnumsCode.Useres.EventMagStaff.toUpperCase()) {
